...
# Purpose       : This script will perform a full backup of a specified database, based on the API functions.
...
# Log files & path
export API_LOGFILE=${db_sid}_rman_backup_full.log
export API_VLOGFILE=${db_sid}_verbose_rman_backup_full.log
export API_LOGPATH="/home/oracle/logs/backup"

# Backup script
export BACKUPSCRIPT="full_backup.rman"

### Main

# Print the configuration to the standart output
print_api_stdoutd "Backup	: FULL"
