#!/bin/ksh
# File          : rman_backup_inc1.sh
# Created on    : 2012/02/22
# Purpose       : This script will perform an incremental level 1 backup of a specified database, based on the API functions.
...
# Log files & path
export API_LOGFILE=${db_sid}_rman_backup_inc1.log
export API_VLOGFILE=${db_sid}_verbose_rman_backup_inc1.log
export API_LOGPATH="/home/oracle/logs/backup"

# Backup script
export BACKUPSCRIPT="inc1_backup.rman"

### Main

# Print the configuration to the standart output
print_api_stdoutd "Backup	: INCREMENTAL LEVEL 1"
